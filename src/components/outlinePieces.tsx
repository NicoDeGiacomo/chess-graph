...
/**
 * Custom piece renderers that give black pieces the same clean outline style
 * as white pieces. Uses the white piece SVG structure with fill swapped to
 * #000000, removing the extra white accent lines that default black pieces have.
 */
export const outlinePieces: PieceRenderObject = {
  // Keep all white pieces as-is
  ...defaultPieces,

  // ── Black Pawn ──────────────────────────────────────────────────────
  // Same single-path shape as wP, fill swapped to black
  bP: (props) => (
  ...
  // ── Black Rook ──────────────────────────────────────────────────────
  // White rook structure (no white accent lines)
  bR: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <g
        style={{
  ...
  // ── Black Knight ────────────────────────────────────────────────────
  // White knight structure; eye & nostril circles use fill:#fff for visibility
  bN: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <g
        style={{
  ...
  // ── Black Bishop ────────────────────────────────────────────────────
  // White bishop structure; cross/detail lines use stroke:#000 (not #fff)
  bB: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <g
        style={{
  ...
  // ── Black Queen ─────────────────────────────────────────────────────
  // White queen structure (no white accent arcs)
  bQ: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <g
        style={{
  ...
  // ── Black King ──────────────────────────────────────────────────────
  // White king structure (no white accent curves)
  bK: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <g
        style={{
      ...
      >
        ...
        <path
          ...
          style={{ fill: props?.fill ?? '#000000', stroke: '#000000', strokeLinecap: 'butt', strokeLinejoin: 'miter' }}
        />
